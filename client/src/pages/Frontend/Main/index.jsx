      ...
      <div className="mainContainer">
        ...
        <div className="!my-5 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 p-4">
          {images.map((img) => (
            <div
              key={img.imageID}
              className="relative w-full sm:h-[300px] h-[150px] overflow-hidden rounded-lg shadow-sm group"
              style={{
            ...
            >
              ...
              <div className="absolute inset-0 bg-[#0000004f] bg-opacity-150 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg flex flex-col justify-between px-4 py-3">
                <div className="flex items-start justify-between">
                  <span className="text-white bg-green-300 rounded-[5px] px-3 py-2 !text-[20px]">
                    <FiDownload />
                  </span>
                  <span className="text-white bg-green-300 rounded-[5px] px-3 py-2 !text-[14px]">
                    PNG
                  </span>
                </div>
