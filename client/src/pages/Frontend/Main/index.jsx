  ...
  const renderPageNumbers = () => {
    ...
    for (let i = 1; i <= totalImagePages; i++) {
      pages.push(
        <button
          key={i}
          className={`px-3 py-1 rounded-[5px] cursor-pointer hover:!bg-[#666] hover:!text-white ${
            page === i
            ...
            >
              ...
              <div className="absolute inset-0 bg-[#0000004f] bg-opacity-150 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg flex flex-col justify-between px-4 py-3">
                <div className="flex justify-between">
                  ...
                  <span className="bg-[#4EAA76] text-white  uppercase  transform scale-0 opacity-0 transition-all duration-500 ease-out group-hover:scale-100 group-hover:opacity-100 !text-[12px] px-2 py-1 rounded shadow !flex !items-center gap-1 "> <FiDownload />
