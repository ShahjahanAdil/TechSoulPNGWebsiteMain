...
const Dcards = ({
  ...
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-[1280px] w-full">
          ...
          <div>
            ...
            >
              ...
              <span className=" absolute top-1 right-1 sm:top-2 sm:right-2  py-2 px-3 text-gray-500 rounded-[5px] text-[14px]">
                <FaHeart />
              </span>
          ...
          {similarImages?.map((similarImg) => {
            return (
              ...
              >
                ...
                <div className="absolute top-0 left-0 w-full !inset-0 hover:!bg-[#00000065]  duration-300 group flex flex-col justify-between p-2 z-10">
   ...
   <span className="!flex justify-center items-center gap-2">
                   <span className="bg-white text-gray-500 !text-[10px] uppercase px-2 py-1 rounded shadow transform scale-0 opacity-0 transition-all duration-500 ease-out group-hover:scale-100 group-hover:opacity-100">
                      <FaHeart className="text-[12px]" />
                    </span>
                    <span className="bg-[#4EAA76] text-white  uppercase  transform scale-0 opacity-0 transition-all duration-500 ease-out group-hover:scale-100 group-hover:opacity-100 !text-[12px] px-2 py-1 rounded shadow !flex !items-center ">
                      <MdOutlineFileDownload className="gap-1" />{" "}
                      {imageDets?.imageURL?.split(".").pop().split(/\#|\?/)[0]}
                    </span>
                </span>
                  ...
                  <div className="text-white text-sm text-center transform scale-0 opacity-0 transition-all duration-500 ease-out group-hover:scale-100 group-hover:opacity-100">
                    {similarImg.title}
                  </div>
                </div>
              </div>
        ...
        <div className="px-2 py-6 space-y-6 mainContainer">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <div className="relative group overflow-hidden rounded">
              ...
              />
              <div className="absolute bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              <div className="absolute top-2 left-2 right-2 flex justify-between opacity-0 transform scale-0 group-hover:opacity-100 group-hover:scale-100 transition-all duration-500 ease-out">
                <span className="bg-white !text-[12px] px-2 z-20 py-1 rounded shadow">
                  Free
                </span>
              </div>
            ...
            <div className="relative group overflow-hidden rounded">
              ...
              <div className="absolute top-2 left-2 right-2 flex justify-between opacity-0 transform scale-0 group-hover:opacity-100 group-hover:scale-100 transition-all duration-500 ease-out">
                ...
                <span className="bg-white !text-[12px] !flex items-center px-2 py-1 rounded shadow">
            ...
            <div className="relative group overflow-hidden rounded">
              ...
              <div className="absolute top-2 left-2 right-2 flex justify-between opacity-0 transform scale-0 group-hover:opacity-100 group-hover:scale-100 transition-all duration-500 ease-out">
                ...
                <span className="bg-white !text-[12px] !flex items-center px-3 rounded shadow">
                  <FaHeart className="text-red-500" />
                </span>
              </div>
              <span className="absolute bottom-2 left-2 text-white text-[14px] px-2 py-1 rounded shadow transform scale-0 opacity-0 group-hover:scale-100 group-hover:opacity-100 transition-all duration-500 ease-out">
                Background 5
              </span>
            </div>
            ...
            <div className="relative group overflow-hidden rounded">
              ...
              <div className="absolute top-2 left-2 right-2 flex justify-between opacity-0 transform scale-0 group-hover:opacity-100 group-hover:scale-100 transition-all duration-500 ease-out">
                ...
                <span className="!flex justify-center items-center gap-2">
                  <span className="bg-white !text-[12px] flex items-center px-2 py-2 rounded shadow">
                    <FaHeart className="text-gray-500" />
                  </span>
                  <span className="bg-green-500 text-white !text-[12px] px-2 py-1 rounded shadow !flex !items-center">
                    <MdOutlineFileDownload className="gap-1" /> PNG
                  </span>
                </span>
              </div>
