    ...
    <>
      ...
      <section className="navbar relative w-full h-14 bg-[#FFFFFF] flex justify-between items-center !gap-5 px-5">
        ...
        <div className="below-nav flex justify-center items-center gap-6 ">
          ...
          {/* Login Profile */}
          <div className="login relative hidden xl:block">
            <div className="absolute flex flex-col items-center justify-between min-h-[400px] w-[300px] bg-white rounded-[12px] right-0 top-0 !p-5 shadow-lg">
              {/* Profile Content */}
              <div>
                <div
